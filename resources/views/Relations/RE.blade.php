...
<body>
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">{{__('message_offer.user name')}}</th>
      <th scope="col">{{__('message_offer.user email')}}</th>
      <th scope="col">{{__('message_offer.user phone')}}</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$users->email}}</td>
      <td>{{$users->mobile}}</td>
      <td><a href="">{{__('message_offer.show')}}</a></td>
      <td><a href="">{{__('message_offer.Delete')}}</a></td>
    </tr>
    @endforeach
    @endif
  </tbody>
